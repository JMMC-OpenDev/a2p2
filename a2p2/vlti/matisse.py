...
class Matisse(VltiInstrument):
    ...
    def checkOB(self, ob, p2container, dryMode=True):
        ...
        for observationConfiguration in ob.observationConfiguration:
            ...
            if dryMode:
                ...
                self.createPionierOB(ui, self.facility.a2p2client.getUsername(), api, containerId, obTarget, obConstraints, acqTSF, obsTSF, OBJTYPE, instrumentMode, DIAMETER, COU_AG_GSSOURCE, GSRA, GSDEC, COU_GS_MAG, dualField, SEQ_FT_ROBJ_NAME, SEQ_FT_ROBJ_MAG, SEQ_FT_ROBJ_DIAMETER, SEQ_FT_ROBJ_VIS, LSTINTERVAL)
    ...
    def createGPionierOB(self,ui, username, api, containerId, obTarget, obConstraints, acqTSF, obsTSF, OBJTYPE, instrumentMode,
